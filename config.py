...
BOT_TOKEN = getenv("BOT_TOKEN", 6815420841:AAFOLirB9nqPaGcc17DoAXtdjsfSGTyYrQs)
...
SUPPORT_GRP = getenv("SUPPORT_GRP", "synaxchatrobot")
UPDATE_CHNL = getenv("UPDATE_CHNL", "synaxnetwork")
OWNER_USERNAME = getenv("OWNER_USERNAME", "s4n6x")
